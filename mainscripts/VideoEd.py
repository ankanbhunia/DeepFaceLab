...
def extract_video(input_file, output_dir, output_ext=None, fps=None):
    ...
    if output_ext is None:
        output_ext = settings.output_img_ext#io.input_str ("Output image format", "png", ["png","jpg"], help_message="png is lossless, but extraction is x10 slower for HDD, requires x10 more disk space than jpg.")
